...
export default function Home() {
  return (
    <div className="flex items-center justify-center min-h-screen font-sans">
      <main className="flex flex-col items-center w-full max-w-3xl gap-8 px-16 py-8 sm:items-start">
        <CalendarImage />
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-orange-400 dark:text-zinc-50">
            diary of theLiftedGifted — <TodayDate />
          </h1>
          <p className="max-w-md text-lg leading-8 text-orange-600 dark:text-orange-400">
