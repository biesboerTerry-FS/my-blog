        ...
        {posts.length === 0 ? (
          ...
          posts.map((post) => {
            ...
            return (
              <article
                key={post.slug}
                className="p-6 bg-white dark:bg-black rounded-lg transition-all duration-300 hover:border hover:border-gray-900 dark:hover:border-white hover:shadow-lg hover:shadow-gray-900/10 dark:hover:shadow-white/10 hover:-translate-y-1"
              >
